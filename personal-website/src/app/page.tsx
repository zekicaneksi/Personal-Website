...
export default function Home() {
  ...
  return (
    <div className={styles.outerContainerCss}>
        ...
        <div className={styles.innerContainerCss} onClick={() => {if(aRef?.current) aRef.current.click()}}>
            <a target="_blank" href="/zeki_can_eksi_cv_en.pdf" style={{position: 'absolute', pointerEvents: 'none'}} ref={aRef}></a>
